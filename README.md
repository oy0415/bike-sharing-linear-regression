...
**手法** : 単回帰モデルと2次項付き回帰を比較する\
**評価方法** : 残差図、AIC、Q-Q plot等\
**結果** : 2次項モデルにすることで、AICと残差傾向の面で改善\
**使用技術** : Python / pandas / seaborn / statsmodels
...
![residual_plot1](results/residual_plot1.png)
...
![residual_plot2](results/residual_plot2.png)
---
...
![qq_plot1](results/qq_plot1.png) 
![qq_plot2](results/qq_plot2.png)
---
#### Scale-Location Plot
...
![scale_location1](results/scale_location1.png)
![scale_location2](results/scale_location2.png)
---
